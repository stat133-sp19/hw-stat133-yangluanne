...
A look through each player’s data sets shows that not every player attempted the same number of shots, but does more shots make a player more effective in the team? Is a player's contribution to the team success dependent on the number of shots they make?
