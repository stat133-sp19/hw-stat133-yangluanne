...
Each player on a basketball team has a role. For the Warriors, Stephen Curry was the point guard, Kevin Durant and Draymond Green were the power fowards, Andre Iguodala was the small forward, and Klay Thompson was the shooting guard. 
...
A look through each player’s data sets show that not every player attempted the same number of shots, but does more shots mean more points?
