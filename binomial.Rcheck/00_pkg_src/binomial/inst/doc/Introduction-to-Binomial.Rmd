...
For example, if we want to find the probability of getting 2 heads out of 5 flips of the fair coins (\(P(X = x) = 2\)), call `bin_probability()` with arguments, 2, 5, and 0.5.
```{r}
